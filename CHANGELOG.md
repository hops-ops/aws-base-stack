...
* chore: file-based env vars for e2e tests (#18) (by @patrickleet)
...
* feat(deps): update dependency aws-pod-identity to v0.9.0 (#22) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.11.0...v0.12.0](https://github.com/hops-ops/aws-base-stack/compare/v0.11.0...v0.12.0)
